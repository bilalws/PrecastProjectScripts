...
class CreateWall():
    ...
    def create(self, build_ele):
        ...
        self.wall_length2  = build_ele.Length1_2.value #860
        self.wall_angle  = 50

        self.wall_type = build_ele.radio_angle_type.value #3
        ...
        x,y = self.point_from_angle(self.wall_length2,self.wall_angle)
        #NemAll_Python_Utility.ShowMessageBox('%6.2f' %y,1)

        self.wall_l2_x  = x
        self.wall_l2_y  = y
        self.theta      = 90 - self.wall_angle
        ...
        # get shading back
        self.shading_back_l1=build_ele.shading_back_l1.value
        self.shading_back_l2=build_ele.shading_back_l2.value
        self.shading_back_h1=build_ele.shading_back_h1.value
        self.shading_back_h2=build_ele.shading_back_h2.value
    ...
    def point_from_angle(self,length,angle):
    ...
    def create_rein_shading_back(self):
        ...
        z1_ref= self.windows_refz + self.windows_width + z_cover_offset
        stirrup_length = self.wall_length

        stirrup_start_point = AllplanGeo.Point3D(x1_ref-x_cover_offset, y1_ref, z1_ref)
        stirrup_end_point = AllplanGeo.Point3D(x1_ref-stirrup_length+x_cover_offset_end_shift, y1_ref, z1_ref)
        stirrup_angles = RotationAngles(90, 0, 90)

        
        stirrup_shape = GeneralShapeBuilder.create_open_stirrup(200, 420,
                                                        stirrup_angles,
                                                        shape_prop_stirrup,
                                                        concrete_cover_props,
                                                        0,
        ...
        if (self.wall_type == 2) :
            stirrup_start_point1_2 = AllplanGeo.Point3D(x1_2ref -xy_cover_offset_shift, y1_2ref+xy_cover_offset_shift-5, z1_2ref)

        if (self.wall_type == 3) :
            stirrup_start_point1_2 = AllplanGeo.Point3D(x1_2ref -xy_cover_offset_shift+33, y1_2ref+xy_cover_offset_shift, z1_2ref)


        stirrup_angles1_2 = RotationAngles(90, 0, 90-(90-self.theta))

        stirrup_shape1_2 = GeneralShapeBuilder.create_open_stirrup(200, 420,
                                                        stirrup_angles1_2,
                                                        shape_prop_stirrup,
                                                        concrete_cover_props,
                                                        0,
        ...
        rein_shading_back.append (LinearBarBuilder.create_linear_bar_placement_from_to_by_dist(
                1, stirrup_shape1_2,
                stirrup_start_point1_2,
                stirrup_end_point1_2,
                self.concrete_cover,
                self.concrete_cover,
                self.distance))

        #rein shading horizontal longbar

        x2_cover_offset = 20
        z2_cover_offset = z_cover_offset + 10

        x2_ref= 0
        y2_ref= 0
        z2_ref= self.windows_refz + self.windows_width + z2_cover_offset
        ...
        if (self.wall_type == 3) :
            hori_longbar_2 = self.wall_length2 -xy_cover_offset_shift - 90
            hori_longbar_start_point2 = AllplanGeo.Point3D(x3_ref+xy_cover_offset           , y3_ref +xy_cover_offset+20, z3_ref)
            hori_longbar_end_point2 = AllplanGeo.Point3D(x3_ref+200 -xy_cover_offset+30        , y3_ref + 180 - xy_cover_offset, z3_ref)
    ...
    def create_rein_ver_stirrup(self):
        ...
        y1_ref= 0 
        z1_ref= 0 +self.windows_refz -z_cover_offset

        stirrup_start_point = AllplanGeo.Point3D(x1_ref, y1_ref + y_cover_offset, z1_ref)
        stirrup_end_point = AllplanGeo.Point3D(x1_ref - self.windows_length , y1_ref + y_cover_offset, z1_ref)
        stirrup_angles = RotationAngles(-90, 0, 90)

        stirrup_shape = GeneralShapeBuilder.create_open_stirrup(self.wall_thickness - y_cover_offset*2, z1_ref - 10,
                                                        stirrup_angles,
                                                        shape_prop_stirrup,
                                                        concrete_cover_props,
                                                        -1,
        ...
        rein_ver_stirrup.append (LinearBarBuilder.create_linear_bar_placement_from_to_by_dist(
                1, stirrup_shape,
                stirrup_start_point,
                stirrup_end_point,
                self.concrete_cover,
    ...
    def create_rein_ver_longbar(self):
        ...
        if (self.wall_type == 1) :
            ...
            ver_longbar_start_point6 = AllplanGeo.Point3D(x6_ref-self.wall_length+35   , y6_ref+offset_y-60                   , z6_ref + offset_z)
            ver_longbar_end_point6 = AllplanGeo.Point3D(x6_ref-self.wall_length-self.wall_l2_x+35       , y6_ref+self.wall_l2_y +offset_y-60   , z6_ref + offset_z)
        ...
        if (self.wall_type == 3) :
            ver_longbar_start_point5 = AllplanGeo.Point3D(x5_ref-self.wall_length+25   , y5_ref+offset_y-10                   , z5_ref + offset_z)
            ver_longbar_end_point5 = AllplanGeo.Point3D(x5_ref-self.wall_length-self.wall_l2_x+25       , y5_ref+self.wall_l2_y + offset_y-10  , z5_ref + offset_z)

            ver_longbar_start_point6 = AllplanGeo.Point3D(x6_ref-self.wall_length+70   , y6_ref+offset_y-85                   , z6_ref + offset_z)
            ver_longbar_end_point6 = AllplanGeo.Point3D(x6_ref-self.wall_length-self.wall_l2_x+70       , y6_ref+self.wall_l2_y +offset_y-85   , z6_ref + offset_z)
    ...
    def add_shading_back(self, build_ele ,com_prop_stroke) :
        ...
        x,y = self.point_from_angle(shading_back_l2,self.wall_angle)
        #NemAll_Python_Utility.ShowMessageBox('%6.2f' %x,1)

        shading_back_l2_x = x   #289.25 at 50
        shading_back_l2_y = y   #344.72 at 50
